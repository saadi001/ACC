  ...
  return (
    <div className="py-8" id="about">
      ...
      <div className="py-10 grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-2 items-center gap-">
        ...
        <div>
          <p className="text-lg font-bold text-center md:text-start text-emerald-500">
            About Me
          </p>
          ...
          <p className="mt-5 text-slate-700 px-4 md:px-0">
            ...
            and user experience, and I&apos;m here today to learn more about
            emerging trends in this field and connect with others who share
            similar interests
          </p>
